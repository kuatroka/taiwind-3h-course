...
<header class="bg-teal-700 text-white sticky top-0 z-10">
	<section class="max-w-4xl mx-auto p-4 flex justify-between items-center">
		<h1 class="text-3xl font-medium"><a href="#hero">🚀 Acme Rockets</a></h1>
		<div>
			<button
				id="hamburger-button"
			...
			>
				<!-- &#9776;  -->
				<div
					class="bg-white w-8 h-1 rounded absolute top-4 -mt-0.5 transition-all duration-500 before:content-[''] before:bg-white before:w-8 before:h-1 before:rounded before:absolute before:-translate-x-4 before:-translate-y-3 before:transition-all before:duration-500
			...
			<nav class="hidden md:block space-x-8 text-xl" aria-label="main">
				<a href="#rockets" class="link hover:opacity-90">Our Rockets</a>
				<a href="#testimonials" class="link hover:opacity-90">Testimonials</a>
				<a href="#contact" class="link hover:opacity-90">Contact Us</a>
			</nav>
		</div>
	</section>
	<section
		id="mobile-menu"
		class="absolute top-68 bg-black w-full text-5xl flex-col justify-content-center origin-top
		animate-open-menu hidden text-[#dc143c]"
	>
		...
		<nav class="flex flex-col min-h-screen items-center py-8" aria-label="mobile">
			...
			<a href="#rockets" class="w-full text-center py-6 hover:opacity-90">Our Rockets</a>
...
<main class="max-w-4xl mx-auto">
	...
	<section
		...
		id="rockets"
	>
		<h2 class="text-4xl font-bold text-center sm:text-5xl mb-6">Our Rockets</h2>
		<ul class="list-none mx-auto my-12 flex flex-col sm:flex-row items-center gap-8 justify-center">
			<!-- Updated to align center -->
			<li
				class="w-2/3 sm:w-5/6 flex flex-col items-center border border-solid border-slate-900 dark:border-grey-100 bg-white dark:bg-black py-6 px-2 rounded-3xl shadow-xl"
			>
	...
	<section
		...
		id="testimonials"
	>
		<h2 class="text-4xl font-bold text-center sm:text-5xl mb-6">Testimonials</h2>
		<figure class="my-12">
			<blockquote class="bg-teal-600 dark:bg-black pl-14 pr-8 py-12 rounded-3xl relative">
				<p
					class="text-2xl sm:text-3xl text-left mt-2 text-white dark:text-slate-400 before:content-['“'] before:font-serif before:absolute before:top-0 before:left-0 before:text-9xl before:text-white before:opacity-25 before:transform before:translate-x-2 before:translate-y-2 after:content-['”'] after:font-serif after:absolute after:-bottom-20 after:right-0 after:text-9xl after:text-white after:opacity-25 after:transform after:-translate-x-2 after:-translate-y-2"
				>
		...
		<figure class="my-12">
			<blockquote class="bg-teal-600 dark:bg-black pl-14 pr-8 py-12 rounded-3xl relative">
				...
				>
					...
					several occassions. <span class="italic">This makes me very, very angry!</span> Nevertheless,
					K-9 and I have awarded Acme the Martian contract for space exploration rockets based on Acme's
		...
		<figure class="my-12">
			<blockquote class="bg-teal-600 dark:bg-black pl-14 pr-8 py-12 rounded-3xl relative">
				...
				>
					...
					Infinity Rocket for my mission in space. Acme delivered in one day! Nothing says
					<q class="italic">Take me to your leader</q> like Acme's Infinity Rocket! 💯
				</p>
			</blockquote>
			<figcaption
				class="italic text-xl sm:text-2xl text-right mt-2 text-slate-500 dark:text-slate-400"
	...
	<section
		...
		id="contact"
	>
		<h2 class="text-4xl font-bold text-center sm:text-5xl mb-6">Contact Us</h2>
...
<footer class="bg-teal-700 text-white text-xl" id="footer">
	<section class="max-w-4xl mx-auto p-4 flex flex-col sm:flex-row sm:justify-between">
		...
		<div class="flex flex-col sm:gap-2">
			<p class="text-right">Copyright &copy; {currentYear}</p>
